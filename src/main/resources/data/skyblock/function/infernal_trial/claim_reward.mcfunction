...
execute if score @s sb_infernal_run = #run_id sb_infernal unless score @s sb_infernal_claim = #run_id sb_infernal run function skyblock:infernal_trial/reward/grant
