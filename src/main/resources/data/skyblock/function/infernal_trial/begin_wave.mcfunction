...
execute if score #trial_level sb_infernal matches 7..10 run function skyblock:infernal_trial/spawn_scaling
...
execute store result bossbar skyblock:infernal_trial value run scoreboard players get #wave_total sb_infernal
bossbar set skyblock:infernal_trial visible true
...
execute in minecraft:the_nether positioned 0 64 0 run tellraw @a[distance=..64] [{translate:"skyblockmulti.infernal_trial.started",color:"gold"},{text:" "},{translate:"skyblockmulti.infernal_trial.level",color:"red"},{text:": "},{score:{name:"#trial_level",objective:"sb_infernal"},color:"yellow"}]
...
execute if score #trial_level sb_infernal matches 7 in minecraft:the_nether positioned 0 64 0 run tellraw @a[distance=..64] {translate:"skyblockmulti.infernal_trial.fortress_assault",color:"dark_red",bold:true}
