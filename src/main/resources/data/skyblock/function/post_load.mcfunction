...
execute unless score #capacity sb3_cfg matches 8 unless score #capacity sb3_cfg matches 16 run scoreboard players set #capacity sb3_cfg 8
...
scoreboard players set #max sb3_const 8
