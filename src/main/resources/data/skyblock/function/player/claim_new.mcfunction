...
execute if score #capacity sb3_cfg matches 8 run function skyblock:player/claim_random

# Modo 16.
execute if score #capacity sb3_cfg matches 16 run execute store result score #random_slot sb3_const run random value 1..16
execute if score #capacity sb3_cfg matches 16 run function skyblock:player/claim_random
...
execute if score #capacity sb3_cfg matches 24 if score @s sb_chest matches 3 run function skyblock:player/claim_random_inner8
...
execute if score #capacity sb3_cfg matches 24 if score @s sb_chest matches 3 if score #claim sb3_const matches 0 run function skyblock:player/claim_random_outer16
...
execute if score #capacity sb3_cfg matches 24 unless score @s sb_chest matches 3 run function skyblock:player/claim_random_outer16
...
execute if score #capacity sb3_cfg matches 24 unless score @s sb_chest matches 3 if score #claim sb3_const matches 0 run function skyblock:player/claim_random_inner8
