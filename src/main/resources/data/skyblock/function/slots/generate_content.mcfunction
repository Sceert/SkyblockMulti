...
execute if score #anchors sb3_const matches 24 run tellraw @a [{"text":"[SkyblockMulti] ","color":"aqua","bold":true},{"translate":"skyblockmulti.system.anchors_ready","with":[{"score":{"name":"#capacity","objective":"sb3_cfg"}}],"color":"green"}]
