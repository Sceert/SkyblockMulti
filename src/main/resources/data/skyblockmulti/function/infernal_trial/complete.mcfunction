...
bossbar set skyblockmulti:infernal_trial value 0
bossbar set skyblockmulti:infernal_trial visible false
bossbar set skyblockmulti:infernal_trial players
...
execute as @a if score @s sb_infernal_run = #run_id sb_infernal run function skyblockmulti:infernal_trial/reward/completion_bonus
execute as @a if score @s sb_infernal_run = #run_id sb_infernal unless score @s sb_infernal_claim = #run_id sb_infernal run function skyblockmulti:infernal_trial/reward/grant
